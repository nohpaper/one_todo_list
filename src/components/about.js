  ...
  return (
    <div
      ...
      <div className="flex items-start justify-between gap-[5px] pt-[5px] px-[15px]">
        <textarea name="" id="" className="min-w-[224px] text-2xl font-bold rounded-md resize-none outline-offset-4 focus:outline-blue-600" value={currentData.title} onChange={(e)=>{
      ...
      <div className="pt-[30px] px-[15px] text-right">
        ...
        <button type="button" className="px-[10px] py-[3px] mt-[5px] rounded-md text-white text-[14px] bg-blue-600" onClick={()=>{
            navigate("/"); //list로 이동
            //입력 값 저장
